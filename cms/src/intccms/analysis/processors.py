...
class TwoHundredGbpsProcessor(ProcessorABC):
    """Coffea processor that does nothing. A la 200 Gbps.

    This processor simply loads branches and does nothing with them, trying
    to maximise the throughput rates. This is useful for benchmarking and
    debugging. 
