...
from user.skim_demo import dataset_manager_config, skimming_config
...
statistics_config = {"cabinetry_config": "example-demo/outputs/cabinetry/cabinetry_config.yaml"}
