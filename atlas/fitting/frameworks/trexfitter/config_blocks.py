...
def write_job_block(f, args):
    ...
    f.write(f"  SystPruningNorm: {args.syst_pruning_threshold:g}\n")
    f.write(f"  SystPruningShape: {args.syst_pruning_threshold:g}\n")
...
def write_fit_block(f, args):
    ...
    f.write(f"  LHscanMin: {args.lh_scan_min:g}\n")
    f.write(f"  LHscanMax: {args.lh_scan_max:g}\n")
